...
```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("C02Ia_ml2", part = "III",
    url = "https://github.com/BioDataScience-Course/C02Ia_ml2",
    course.urls = c(
      'S-BIOG-025' = "https://classroom.github.com/a/akIwt7xd"),
