...
<!-- À faire: un diagramme qui montre la relation entre ces différents modules, et avec les modules des deux cours précédents -->
...
Les travaux personnels seront à réaliser en utilisant un espace de travail en ligne dédié à la science des données (renku) ou sur une machine virtuelle préconfigurée, la **'SciViews Box'**, que nous installerons ensemble à la fin du premier module avec les étudiants possédant un ordinateur adapté.
...
- [Plan du cours de Science des données biologiques 3 : années 2021-2022](https://github.com/BioDataScience-Course/BioDataScience-Common/blob/main/docs/plan_de_cours/sdd3_plan_cours_2021-2022.md)
...
if (exists("assignation2"))
  assignation2("sdd_issues", part = NULL,
    ...
    course.urls = c('S-BIOG-025' = "https://classroom.github.com/g/s_U7VaAO"),
...
Vous pouvez retrouver directement ce dépôt via la bannière du site.
