...
Enfin, un dernier module est consacré à une initiation à l'analyse de données spatialisées et à la réalisation de cartes avec R. Ici aussi, il s'agit d'un aspect important pour beaucoup de biologistes, en particuliers ceux qui travaillent sur le terrain.
...
if (exists("assignation2"))
  assignation("sdd_issues", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/g/s_U7VaAO",
