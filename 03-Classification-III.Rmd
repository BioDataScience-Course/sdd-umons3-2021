...
if (exists("assignation"))
  assignation("C03Ia_cardiovascular", part = "I",
...
```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("C03Ia_cardiovascular", part = "II",
    url = "https://github.com/BioDataScience-Course/C03Ia_cardiovascular",
    course.urls = c(
      'S-BIOG-025' = "https://classroom.github.com/a/XEjOaVvQ"),
    toc = "Courbe ROC")
...
```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("C03Ia_cardiovascular", part = "III",
    url = "https://github.com/BioDataScience-Course/C03Ia_cardiovascular",
    course.urls = c(
      'S-BIOG-025' = "hhttps://classroom.github.com/a/XEjOaVvQ"),
...
if (exists("challenge2"))
  assignation("C03Ca_ml_wine", part = NULL,
...
Vous pourrez soumettre vos résultats via l'application ci-dessous\ :

<!-- launch_shiny("https://sdd.umons.ac.be/B01Sa_reglin/", height = 600, delay = 20, toc = "Ajuster la meilleure droite")`-->

<iframe width="780" height="500" frameborder="0" scrolling="auto" class="shiny-app" id=\"C03Ca_ml_wine\" src="https://sdd.umons.ac.be/C03Ca_ml_wine"></iframe>

```{r, echo=FALSE, eval=FALSE}
knitr::include_app('https://sdd.umons.ac.be/C03Ca_ml_wine/', height = '600px')
```
